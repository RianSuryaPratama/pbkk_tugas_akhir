   <div class="page-heading" hidden="" id="pageTransaksiForm">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form method="post" enctype="multipart/form-data" id="transaksiForm">
          ...
          <div class="col-lg-12 mt-3">
            <!-- fasilitas -->
            <button type="button" id="new_detail" style="display: none;" class="btn btn-info text-white btn-sm mb-2">
      ...
      <button type="button" class="btn close mt-3 btn-secondary"> Kembali</button>
    </form>
      ...
      <table id="sample_table_detail">
        <tr id="">
          ...
          <td data-label="Nama Paket">
            ...
            <select name="transaksi[0][id_paket]" readonly style="width: 100%;" id="transaksi_0_id_paket" class="form-control form-control-sm id_paket_input">
          ...
          <td data-label="Berat">
            <input type="number" min="1" disabled="" name="transaksi[0][berat]" id="transaksi_0_berat" class="form-control berat_input">
