...
<head>
  ...
  <title>Login | Laundry_Cemara</title>
      ...
      <div class="authentication-wrapper authentication-basic container-p-y">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <!-- /Logo -->
            <h4 class="mb-2 text-center">Laundry_Cemara</h4>
            <p class="mb-4 text-center">Silakan login dan selamat beraktivitas !👋</p>

            <form id="loginForm" class="mb-3">
              @csrf
              <div class="mb-3">
                <label for="email" class="form-label">Email/Username</label>
                <input type="text" class="form-control" id="" required name="email" placeholder="Masukkan email/username" autofocus />
              </div>
              <div class="mb-3 form-password-toggle">
                ...
                <div class="input-group input-group-merge">
                  <input type="password" id="password" class="form-control" required name="password" placeholder="&#xb7 &#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
                  <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                </div>
              </div>
              <div class="mb-3">
                <div class="form-check">
                  <input class="form-check-input" checked="" disabled="" type="checkbox" id="remember-me" />
